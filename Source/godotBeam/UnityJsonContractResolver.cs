...
namespace Beamable.Server.Common
{
    public class UnitySerializationSettings : JsonSerializerSettings
    {
        ...
        public static UnitySerializationSettings Instance => _instance = _instance ?? new UnitySerializationSettings
        {
    ...
    public class UnityJsonContractResolver : DefaultContractResolver
    {
        ...
        public static UnityJsonContractResolver Instance => _instance = _instance ?? new UnityJsonContractResolver();
